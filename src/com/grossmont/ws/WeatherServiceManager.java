...
{ 
    ...
    public void callWeatherWebService(String sCity){
    	...
    	try {
            ...
            ","icon":"03n"}],
            "base":"cmc stations",
            "main":{"temp":62.65,"pressure":1007.4,"humidity":93,"temp_min":62.65,
            "temp_max":62.65,"sea_level":1028.19,"grnd_level":1007.4},
    ...
    public static void main(String[] args){
        ...
        if (oRun1.getCurrentTemp() > oRun2.getCurrentTemp()) {
            ...
            System.out.println("The highest current temperature is " + 
                    oRun1.getCityName() + " which has a temperature of " + 
                    oRun2.getCurrentTemp() + " degrees fahrenheit");
                 
        } else {
            
            System.out.println("The highest current temprature is " + 
                    oRun2.getCityName() + " which has a temperature of " + 
                    oRun2.getCurrentTemp());
        }
        
        if (oRun1.getHighTemp() - oRun1.getLowTemp() > oRun2.getHighTemp() - 
                oRun2.getLowTemp()) {
            
            System.out.println("The greatest range is " + oRun1.getCityName() + 
                    " with a temperature of " + oRun1.getHighTemp() +
                    " degrees fahrenheit");
        } else {
            
            System.out.println("The greatest range is " + oRun1.getCityName() +
                    " with a temperature of " + oRun2.getHighTemp() + 
                    " degrees fahrenheit");
        }
